...
points(surv.fit.air.sol.18$time+0.2, surv.fit.air.sol.18$surv, type = 's', col = ColorAirSol[1], lwd = 2)
...
points(surv.fit.air.tp.18$time+0.2, surv.fit.air.tp.18$surv, type = 's', col = ColorAirTP[1], lwd = 2)
...
points(surv.fit.water.sol.18$time+0.2, surv.fit.water.sol.18$surv, type = 's', col = ColorWaterSol[1], lwd = 2)
...
points(surv.fit.water.tp.18$time+0.2, surv.fit.water.tp.18$surv, type = 's', col = ColorWaterTP[1], lwd = 2)
